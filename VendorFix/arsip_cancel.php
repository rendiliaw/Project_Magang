	...
	<body>
		...
		<?php
			...
			<form id="form1" name="form1" method="post">
				<?php
					$query_C = mysql_query( "SELECT ccan.*, optima.* FROM ccan LEFT JOIN optima ON ccan.no=optima.no_ccan WHERE ccan.tgl BETWEEN '$tanggal_awal_C' AND '$tanggal_akhir_C' AND ccan.stts LIKE '%Cancel%' AND optima.vdr= '$idven' GROUP BY ccan.no ORDER BY ccan.tgl ASC, ccan.no ASC" )or die( mysql_error() );
