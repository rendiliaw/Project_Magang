...
<body>
		...
		<div class="container-fluid">
			<div class="collapse navbar-collapse" id="inverseNavbar1">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li>
						<a href="VendorV.php" onclick="return backask();">Kembali</a>
					</li>
					<div class="dropdown">
	...
	<form id="form1" name="form1" method="post">
		<table width="100%" height="178" border="1" class="zebra-table">
			<thead>
				<?php
				if ($stts != 'Close 2' || $stts != 'Order'){
					?>
					<tr>
						<td colspan="14" width="113"><a type="button" class="btn btn-primary btn-sm center-block" href="VendorVE.php?ni=<?php echo $no;?>" title="tambah">Tambah Keterangan</a>
						</td>
					</tr>
					<?php
				}else{
