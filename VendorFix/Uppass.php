		...
		<div class="container-fluid">
			<div class="collapse navbar-collapse" id="inverseNavbar1">
				<ul class="nav navbar-nav navbar-right">
					<li>
						<a href="../VendorFix/VendorV.php" onclick="return backask()">Kembali</a>
					</li>
					<li>
						<a href="../Config/logout.php" onclick="return logoutask();">selamat datang&nbsp;<?php echo $namamu ?>,&nbsp;Log Out</a>
					</li>
				</ul>
			</div>
		</div>
