<?php
	...
	$query_C = mysql_query( "SELECT ccan.*, optima.*, vendor.* FROM ccan LEFT JOIN optima ON ccan.no=optima.no_ccan LEFT JOIN vendor ON ccan.no=vendor.no_ccanw WHERE ccan.stts LIKE '%Cancel%' AND optima.vdr= '$idven' ORDER BY ccan.tgl ASC, ccan.no ASC" );
	$_data = mysql_fetch_array( $query_C );
?>
<html>
	<head>
		<title>Telkom</title>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<div class="dropdown">
							...
							<div class="dropdown-content">
								...
								<a href="../Config/logout.php" onclick="return deleteask();">Log Out</a>
							</div>
						</div>
					</ul>
				</div>
