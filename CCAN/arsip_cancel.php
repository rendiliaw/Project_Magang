		...
		<div id="menu1" class="tab-pane fade">
				...
				<table width="70%" border="0">
					<tbody>
						<tr>
							...
							<td width="25%"><input name="dateaw" type="date" autofocus required="required" id="dateaw" value ="<?php echo $tanggal_awal1; ?>">
							</td>
							<td width="20%">Sampai Tanggal</td>
							<td width="21%"><input name="dateak" type="date" required="required" id="dateak" value ="<?php echo $tanggal_akhir1; ?>" >
							</td>
			...
			if ( isset( $_REQUEST[ 'cari' ] ) ) {
				...
				<form id="form1" name="form1" method="post">
					<?php
					$query_C = mysql_query( "SELECT ccan.*, optima.*, vendor.* FROM ccan LEFT JOIN optima ON ccan.no=optima.no_ccan LEFT JOIN vendor ON ccan.no=vendor.no_ccanw WHERE ccan.tgl BETWEEN '$tanggal_awal_C' AND '$tanggal_akhir_c' AND ccan.stts LIKE '%Cancel%' GROUP BY ccan.no ORDER BY ccan.tgl ASC, ccan.no ASC" )or die( mysql_error() );
			...
			<div id="menu2" class="tab-pane fade">
				...
				if ( isset( $_REQUEST[ 'cari2' ] ) ) {
					...
					<form id="form1" name="form1" method="post">
						<?php
						$query_I = mysql_query( "SELECT * FROM ccan WHERE od = '$order_srch' AND stts LIKE '%Cancel%' ORDER BY no ASC, tgl ASC" );
