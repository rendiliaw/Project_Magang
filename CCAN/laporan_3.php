...
<body >
	...
	<ul class="nav nav-tabs">
		...
		<li><a data-toggle="tab" href="#menu5">Pencarian Individu</a>
		</li>
	</ul>
		...
		<div id="menu5" class="tab-pane fade">
					...
					<table width="70%" border="0">
						<tbody>
							<tr>
								...
								<td width="15%"><input type="submit" name="cari5" id="cari5" value="Submit">
								</td>
							</tr>
						</tbody>
					</table>
				...
				<form id="form3order" name="form3" method="post">
					<table width="96" border="0" class="center-block">
						<tbody>
							<tr>
								<td><button type="button" class="btn btn-sm btn-default">Tambah Order</button>
								</td>
							</tr>
						</tbody>
					</table>
				...
				if ( isset( $_REQUEST[ 'cari5' ] ) ) {
					...
					<form id="form1" name="form1" method="post">
						<?php
						$query_I = mysql_query( "SELECT * FROM ccan WHERE od = '$order_srch' AND stts NOT LIKE '%Close 2%' OR stts NOT LIKE '%Cancel%' ORDER BY no ASC, tgl ASC" );
