...
<body>
	...
	<form id="form1" name="form1" method="post">
		<?php
		$query_CC = mysql_query( "SELECT ccan.*, optima.* FROM ccan LEFT JOIN optima ON ccan.no=optima.no_ccan WHERE optima.stts_op LIKE '%Pelaksanaan%' OR optima.stts_op = 'Close 1' GROUP BY ccan.no ORDER BY ccan.tgl ASC, ccan.no ASC" )or die( mysql_error() );
