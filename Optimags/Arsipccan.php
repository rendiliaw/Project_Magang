...
$tanggal_awal_C2 = ubahTanggalaw( $rawaw );
...
$tanggal_akhir_C2 = ubahTanggalak( $rawwk );
?>
<html>
<head>
	<title>Telkom</title>
...
<body>
	...
	if ( isset( $_REQUEST[ 'cari' ] ) ) {
		...
		<form id="form1" name="form1" method="post">
			<?php
			$query_CC = mysql_query( "SELECT ccan.*, optima.* FROM ccan LEFT JOIN optima ON ccan.no=optima.no_ccan  WHERE ccan.tgl BETWEEN '$tanggal_awal_C2' and '$tanggal_akhir_C2' AND ccan.stts LIKE '%Close 2%' GROUP by ccan.no ORDER BY ccan.tgl ASC, ccan.no ASC" )or die( mysql_error() );
