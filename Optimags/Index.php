...
<body>
	...
	<div class="tab-content">
		<div id="menu1" class="tab-pane fade">
			<form id="form2" name="form2" method="postform" action="Index.php">
			...
			if ( isset( $_REQUEST[ 'cari' ] ) ) {
				...
				<form id="form1" name="form1" method="post">
					<?php
					$query_I = mysql_query( "SELECT * FROM ccan WHERE tgl BETWEEN '$tanggal_awal_I' AND '$tanggal_akhir_I' AND stts LIKE '%Order%' ORDER BY tgl ASC, no ASC " );
					while ( $data = mysql_fetch_array( $query_I ) ) {
						...
						<div id="data-table">
							<div id="tabelku">
								<table width="83%" border="" align="center" class="zebra-table">
									<thead>
									...
									<tbody>
										<tr style="text-align: center">
											...
											<td p align="center">
												<a type="button" class="btn btn-primary btn-sm center-block" href="Detail.php?ni=<?php echo $data['no'];?>" title="Detail">Lihat Detail
												</a>
											</td>
										</tr>
									</tbody>
