...
if(isset($_GET['ni'])){
	$ni		= $_GET['ni'];
	$loginmu=mysql_query("select * from login where no ='$ni'")or die(mysql_error());
	$data=mysql_fetch_array($loginmu);
	$email=$data['email'];
}
?>
<html>
				...
				<div class="row">
					<div class="col-sm-6 col-md-4 col-md-offset-4">
						...
						<div class="account-wall">
							...
							<form role="form1" id="form1" method="post" action="../Config/updateadmin.php" class="form-signin" onload="addSubject()">
								<td><input name="number" type="number" id="number" readonly maxlength="5" value="<?php echo $ni; ?>" hidden="">
									<input type="text" name="usernames" class="form-control" placeholder="username" id="form-username" value="<?php echo $data['username'] ?>" required autofocus>
									...
									<input type="email" name="email" class="form-control" placeholder="Email" id="form-email" value="<?php echo $email ?>" required>
